...
[이 블로그의 다른 포스팅 - CoordinatorLayout]() 을 보고 와야 한다!
...
6. __스크롤 상태에 따라 MaterialToolbar 사라지거나 나타나는 효과 구현하기__
    ...
    먼저 스크롤 뷰의 스크롤 상태가 MaterialToolbar
...
https://developer.android.com/reference/androidx/coordinatorlayout/widget/CoordinatorLayout#setFitsSystemWindows(boolean)