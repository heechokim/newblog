...
* __dp(Device Independence Pixel)__
    ...
    휴대폰 디바이스는 화면 사이즈가 같은 기기라도 __화면의 밀도는 다를 수 있다.__
    ...
    안드로이드는 이렇게 화면 밀도가 다른 다양한 휴대폰 디바이스를 지원하기 위해 __dp__ 라는 측정 단위가 존재한다.
    ...
    밀도가 높은 화면의 2dp x 2dp 이미지에 사용된 픽셀 수가 더 많다.
